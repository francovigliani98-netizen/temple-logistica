...
async function loadData(){
  ...
  try{
    ...
    renderTarifario();
    showLoading(false);
  }catch(err){showLoading(false);showError('No se pudo conectar con la base de datos.');console.error(err);}
}
...
function renderComparador(){
  ...
  mkChart('c-radar-cmp',{type:'radar',data:{labels:radarLabels,datasets:[
    {label:mesA,data:dA,borderColor:COLORS.blue,backgroundColor:'rgba(37,99,235,0.15)',pointBackgroundColor:COLORS.blue,borderWidth:2},
    {label:mesB,data:dB,borderColor:COLORS.teal,backgroundColor:'rgba(13,148,136,0.15)',pointBackgroundColor:COLORS.teal,borderWidth:2}
  ]},options:{responsive:true,maintainAspectRatio:false,
